  ...
  <div class="card-body">
    <?php 
      ...
      if ($array ->num_rows > 0) 
      {
         ...
         {
            if ($row['action'] == 'Cashout') 
            {
              echo "<div class='alert alert-secondary'>You Cashout Tk.$row[debit] from your account at $row[date]</div>";
            }
            if ($row['action'] == 'Cashin') 
            {
              echo "<div class='alert alert-success'>You Cashin Tk.$row[credit] in your account at $row[date]</div>";
            }
