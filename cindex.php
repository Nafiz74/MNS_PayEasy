...
<head>
  ...
  <?php $note ="";
    ...
    if (isset($_POST['Cashout']))
    {
      ...
      makeTransactionAgent('Cashout',$_POST['amount'],$_POST['checkno'],$_POST['userId']);
      $note = "<div class='alert alert-success'>successfully transaction done</div>";
    ...
    if (isset($_POST['Cashin']))
    {
      ...
      makeTransactionAgent('Cashin',$_POST['amount'],$_POST['checkno'],$_POST['userId']);
      $note = "<div class='alert alert-success'>successfully transaction done</div>";
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"><a class="nav-link" href="transfer.php">Send Money</a></li> -->
        ...
        $array3 = $con->query("select * from userAccounts where accountNo = '$_POST[otherNo]'");
        {
          ...
          { $row2 = $array2->fetch_assoc();
            echo "<div class='row'>
                  ...
                  <div class='col'>
                    Bank Balance
                    <input type='text' class='form-control my-1'  value='Tk.$row2[balance]' readonly required>
                    <input type='number' class='form-control my-1' name='checkno' placeholder='Write Account Number' required>
                    <input type='number' class='form-control my-1' name='amount' placeholder='Write Amount' max='$row2[balance]' required>
                   <button type='submit' name='CashoutOther' class='btn btn-success btn-bloc btn-sm my-1'> Cashout</button></form>
                  </div>
                </div>";
            ...
            <div class='row'>
                  ...
                  <div class='col'>
                   ...
                   <input type='number' class='form-control my-1' name='checkno' placeholder='Write Check Number' required>
                    <input type='number' class='form-control my-1' name='amount' placeholder='Write Amount for Cashin'  required>

                   <button type='submit' name='Cashin' class='btn btn-success btn-bloc btn-sm my-1'> Cashin</button></form>
                  </div>
                </div>
            ";
          }
